...
class DR extends BS
{
	...
	void displayMSG() //access modifier is default or package
	{
...
class Tester
{
	public static void main(String args[])
	{
		...
		DR d1=new DR();
		BS b2=new DR();
		System.out.println(b1 instanceof BS);
 		System.out.println(b1 instanceof DR);
		System.out.println(b1 instanceof Object);
		System.out.println(d1 instanceof BS);
		System.out.println(d1 instanceof DR);
		System.out.println(d1 instanceof Object);
		System.out.println(b2 instanceof BS);
		System.out.println(b2 instanceof DR);
